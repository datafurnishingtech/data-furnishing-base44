...
export const COMPANY_QUALITY_FIELDS = [
  ...
  "source_url", "source_notes", "domain", "canonical_url", "furnisher_status", "entity_type",
  ...
  "crawl_status", "crawl_source_urls", "evidence_sources", "enrichment_data", "data_completeness_score",
